...
async def draw_rectangle(x1: int, y1: int, x2: int, y2: int) -> dict:
    ...
    try:
        ...
        paint_window.click_input(coords=(440, 62))
        time.sleep(0.2)
        ...
        if not canvas:
            return {
                "content": [
                    TextContent(
                        type="text",
                        text="Canvas area not found in Paint."
                    )
                ]
            }
...
async def add_text_in_paint(text: str) -> dict:
    ...
    try:
        ...
        # Ensure Paint window is active
        if not paint_window.has_focus():
            print("paint does not have focus")
            paint_window.set_focus()
            time.sleep(0.5)
        
        # Click on the Rectangle tool
        # paint_window.click_input(coords=(750, 100))
        # time.sleep(0.5)
        ...
        # time.sleep(0.5)
         ...
         # Click on the Rectangle tool
        paint_window.click_input(coords=(293, 68))
        time.sleep(0.2)
        
        # Click where to start typing
        canvas.click_input(coords=(435, 157))
        time.sleep(0.5)
